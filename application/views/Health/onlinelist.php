...
<body>
   ...
   <script>
      ...
      var id = "435593200";
      var username = "pinkeegupta";
      var mystatus = "0";
      var accesskey = "";
      var mygender = "Female";
      var mobile_block = "1";
      var totalphotos = "4";
      var basic_edu_type = "normal";
      var basic_work_type = "normal";
      var photo_link = "https://msg.quackquack.in/uploadphoto/";
   </script>
   <script type="text/javascript" src="https://scpassets.quackquack.co/myprofilev42.js"></script>
   <div id="fb-root"></div>
   <script type="text/javascript">
      $(".number_block").click(function(e) {
          e.stopPropagation();
      });
   ...
   <div class="popup" style="display: none;" id="requestpopup">
      <span class="transparent"></span>
      <div class="boxMain invite_block reqcont">
         <span class="close_icon"></span>
         <div class="req_img"><span id="send_contact_image" class="req_photo"></span></div>
         <p id="send_contact_content"><span id="request_content_before">A request will be sent to <span id='username_before_text'></span> asking her to give access to her contact number. You will be able to see her number when she approves.</span><span id="request_content_after" style="display:none;">Your request has been sent to <span id='username_after_text'></span>. When she accepts your request, you will be able to see her contact number under Messages > Contacts.</span>
         </p>
         <span class="submitBtn chatnowBtn">
         <input type="button" id="send_contact_button" value="">
         </span>
      </div>
   </div>
   ...
   <script>
      setInterval(function() {
          $("#animcircles").toggleClass("animated");
      }, 4000);
      setTimeout(function() {
          $("#upgRight").addClass("nodisplay");
      }, 5000);
      
      $('html').click(function(e) {
          if (e.target.id == 'upgicoimg' || $(e.target).parents('#upgicoimg').length > 0) {
              $("#upgRight2").addClass("rotateInDownRight");
              $("#upgRight2").removeClass("rotateOutUpRight");
          } else {
              if ($("#upgRight2").hasClass("rotateInDownRight")) {
                  $("#upgRight2").removeClass("rotateInDownRight");
                  $("#upgRight2").addClass("rotateOutUpRight");
              }
          }
      });
      
      $('html').click(function(e) {
          if (e.target.id == 'upgicoimg2' || $(e.target).parents('#upgicoimg2').length > 0) {
              $("#upgRight3").addClass("rotateInDownRight");
              $("#upgRight3").removeClass("rotateOutUpRight");
          } else {
              if ($("#upgRight3").hasClass("rotateInDownRight")) {
                  $("#upgRight3").removeClass("rotateInDownRight");
                  $("#upgRight3").addClass("rotateOutUpRight");
              }
          }
      });
   ...
   <script>
    $(document).ready(function(){
      var urls = "<?= base_url('images/gallery/'); ?>";
    ...
    firebase.database().ref('/online/').on('child_added',function(snapshot)
    {
      ...
      if(data.image1 !="")
      {
        var imgURL = urls+data.image1; 
      }else{
        var imgURL = urls+'admin.jpg'; 
      }
      console.log(data);
      if(data.isOnline)
      {
        if(data.user_id != sender_user  && data.gender != gender)
        {
         var append = `<div class="container" id="insert">
                        <img src='${imgURL}'" alt="Avatar" style="width:100%;">
                        <span class="content-c" style="color: red;">${data.user_name}, ${data.age}  </span>
                         <p class="content-c">${data.city_name}</p>
                        <span class="time-right">
                          <a href="${base_url+'welcome/chats/'+data.user_id}"><button class="w3-button w3-green">Chat now</button></a>
                        </span>
                      </div>`;
        }
