					...
					<div class="col-lg-12">
						<div class="single-blog-wrapper new-block">
							<div class="img-holder">
								<img src="<?php echo base_url();?>images/img94.jpg" alt="" class="img-responsive">
							</div>
							<div class="blog-txt">
								<div class="inner-txt-block">
									<a href="#"><h2> Nam vulputate vitae mauris at facilisis. Fusce vel eros commodo, consequat augue sit amet.</h2></a>
								...
								<div class="blog_slider owl-carousel owl-theme">
									<div class="item">
										<div class="block-stl8">
											<div class="img-holder">
												<img src="<?php echo base_url();?>images/img95.jpg" alt="" class="img-responsive">
											</div>
											<div class="txt-block">
												<h4><a href="#">Nulla facilisis nisl vitvolutpat placerat. Pellent habitant morbi tristique .</a></h4>
												<p>Sed iaculis ligula ut magna dignissim, et cursus lorem faucibus. Nullam porta mi ac erat venenatis.</p>
											</div>
										</div>
									</div>
									<div class="item">
										<div class="block-stl8">
											<div class="img-holder">
												<img src="<?php echo base_url();?>images/img96.jpg" alt="" class="img-responsive">
											</div>
											<div class="txt-block">
												<h4><a href="#">Nulla facilisis nisl vitvolutpat placerat. Pellent habitant morbi tristique .</a></h4>
												<p>Sed iaculis ligula ut magna dignissim, et cursus lorem faucibus. Nullam porta mi ac erat venenatis.</p>
									...
									<div class="item">
										<div class="block-stl8">
											<div class="img-holder">
												<img src="<?php echo base_url();?>images/blog-img.jpg" alt="" class="img-responsive">
											</div>
											<div class="txt-block">
												<h4><a href="#">Nulla facilisis nisl vitvolutpat placerat. Pellent habitant morbi tristique .</a></h4>
												<p>Sed iaculis ligula ut magna dignissim, et cursus lorem faucibus. Nullam porta mi ac erat venenatis.</p>
						...
						<div class="comments-block">
							...
							<div class="comment-box new-block">
								<div class="img-block">
									<div class="img-holder">
										<img src="<?php echo base_url();?>images/img97.jpg" alt="" class="img-responsive">
									</div>
								</div>
								<div class="comment">
							...
							<div class="comment-box new-block">
								<div class="img-block">
									<div class="img-holder">
										<img src="<?php echo base_url();?>images/img98.jpg" alt="" class="img-responsive">
									</div>
								</div>
								<div class="comment">
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec tempor aliquam nulla, eu tempor felis elementum eget. In dapibus pharetra dignissim. Nam mattis odio nisl, eget imperdiet leo fringilla eu. </p>
							...
							<div class="replied new-block">
								<div class="comment-box new-block">
									<div class="img-block">
										<div class="img-holder">
											<img src="<?php echo base_url();?>images/img99.jpg" alt="" class="img-responsive">
										</div>
									</div>
									<div class="comment">
										<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec tempor aliquam nulla, eu tempor felis elementum eget. In dapibus pharetra dignissim. Nam mattis odio nisl, eget imperdiet.</p>
										<div class="about-commenter">
											<p><span>John Deo</span> - 2 Day Ago <a href="#" class="replay-btn"><i class="fa fa-share"></i> replay</a></p>
										</div>
									</div>
								</div>
							</div>
							<hr class="hr new-block"><!-- hr -->
							<div class="comment-box new-block">
								<div class="img-block">
									<div class="img-holder">
										<img src="<?php echo base_url();?>images/img99.jpg" alt="" class="img-responsive">
						...
						<form>
							<div class="row">
								...
								<div class="col-lg-12 text-center">
									<div class="from-group">
										<a href="#" class="c-btn btn1">Send</a>
									</div>
								</div>
							</div>
						</form>
...
<!-- Mirrored from www.rewebso.com/html/lamour_html/blog_single.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 May 2019 11:06:41 GMT -->
</html>